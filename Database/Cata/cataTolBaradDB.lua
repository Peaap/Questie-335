...
overlay.npcData = {
    ...
    [47240] = {'Commander Marcus Johnson',387450,387450,85,85,1,{[5095]={{-1,-1}},[5389]={{73.4,59.17}}},nil,5389,nil,nil,2354,"A","",3},
    ...
    [48039] = {'Commander Stevens',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{-1,-1}}},nil,5389,nil,nil,2354,"A","Baradin's Wardens",3},

    [48061] = {'2nd Lieutenant Wansworth',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{-1,-1}}},nil,5389,nil,nil,1802,"A","Baradin's Wardens",2},

    [48062] = {'Staff Sergeant Lazgar',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{-1,-1}}},nil,5389,nil,nil,2355,"H","Hellscream's Reach",2},

    [48066] = {'Sergeant Parker',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{-1,-1}}},nil,5389,nil,nil,2354,"A","Baradin's Wardens",3},

    [48069] = {'Commander Zanoth',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{-1,-1}}},nil,5389,nil,nil,2355,"H","Hellscream's Reach",2},

    [48070] = {'Drillmaster Razgoth',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{-1,-1}}},nil,5389,nil,nil,2355,"H","Hellscream's Reach",2},

    [48071] = {'Private Garnoth',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{-1,-1}}},nil,5389,nil,nil,2355,"H","Hellscream's Reach",2},

    [48074] = {'Marshal Fallows',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{-1,-1}}},nil,5389,nil,nil,1802,"A","Baradin's Wardens",2},

    [48144] = {'Wildlife Kill Credit - Tol Barad Quest - The Leftovers',1,1,1,1,0,nil,nil,0,nil,nil,35,"AH","",0},

    [48250] = {'Lieutenant Farnsworth',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{74.78,59.6}}},nil,5389,nil,nil,2354,"A","",3},
    ...
    [48254] = {'Sergeant Gray',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{72.93,60.94}}},nil,5389,nil,nil,2354,"A","",3},

    [48255] = {'Camp Coordinator Brack',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{73.73,57.57}}},nil,5389,nil,nil,2354,"A","",3},
    ...
    [48356] = {'Karosh',77490,77490,85,85,0,{[5095]={{-1,-1}}},nil,5389,nil,nil,2355,"H","Armorsmith",4224},

    [48357] = {'Hellscream\'s Reach Recruit',77490,77490,85,85,0,{[5095]={{-1,-1}}},nil,5389,nil,nil,2355,"H","",0},

    [48358] = {'Commander Larmash',77490,77490,85,85,0,{[5095]={{-1,-1}}},nil,5389,nil,nil,2355,"H","",2},

    [48360] = {'3rd Officer Kronkar',77490,77490,85,85,0,{[5095]={{-1,-1}}},nil,5389,nil,nil,2355,"H","",2},

    [48361] = {'Private Sarlosk',77490,77490,85,85,0,{[5095]={{-1,-1}}},nil,5389,nil,nil,2355,"H","",2},

    [48363] = {'Captain Prug',77490,77490,85,85,1,{[5095]={{-1,-1}}},nil,5389,nil,nil,2355,"H","",2},

    [48531] = {'Pogg',77490,77490,85,85,0,{[5095]={{-1,-1}}},nil,5389,nil,nil,2355,"H","Hellscream's Reach Quartermaster",128},
    ...
    [50164] = {'Tulgar Flamefist',61992,61992,85,85,0,{[5095]={{-1,-1}}},nil,5389,nil,nil,29,"H","Tol Barad Battle-Mage",0},

    [50167] = {'Rhagha',61992,61992,85,85,0,{[5095]={{-1,-1}},[5389]={{-1,-1}}},nil,5389,nil,nil,29,"H","Tol Barad Battle-Mage",0},

    [50173] = {'Maven Zara',61992,61992,85,85,0,{[5095]={{-1,-1}},[5389]={{-1,-1}}},nil,5389,nil,nil,12,"A","Tol Barad Battle-Mage",0},
    ...
    [51287] = {'Colonel Karzag',77490,77490,85,85,0,{[5095]={{-1,-1}}},nil,5389,nil,nil,2355,"H","",2},

    [51288] = {'Major Marsden',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{74.56,60.95}}},nil,5389,nil,nil,2354,"A","",2},

    [52015] = {'Captain Jake Sones',77490,77490,85,85,0,{[5095]={{-1,-1}},[5389]={{75.01,60.38}}},nil,5389,nil,nil,2354,"A","",3},

    [52016] = {'Petty Officer Chulok',77490,77490,85,85,0,{[5095]={{-1,-1}}},nil,5389,nil,nil,2355,"H","Hellscream's Reach",3},
