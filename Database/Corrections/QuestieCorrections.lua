...
---@type GrimfallScaledZoneQuestCorrections
local GrimfallScaledZoneQuestCorrections = QuestieLoader:ImportModule("GrimfallScaledZoneQuestCorrections")
...
do
    ...
    function QuestieCorrections:MinimalInit() -- db already compiled
        ...
        if QuestieCompat.Is335 then
            addOverride(QuestieDB.questDataOverrides, GrimfallScaledZoneQuestCorrections:Load())
        end
...
function QuestieCorrections:Initialize(validationTables)
    ...
    if Questie.IsWotlk then
        ...
        if QuestieCompat.Is335 then
            _LoadCorrections("questData", GrimfallScaledZoneQuestCorrections:Load(), QuestieDB.questKeysReversed, validationTables)
        end
