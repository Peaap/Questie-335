...
QuestieCompat.RegisterCorrection("questData", function()
	...
	return {
        ...
        -- Custom 3.3.5 prestige quest. Keeps Questie from treating it as missing
        -- while the server-provided quest log supplies live objective progress.
        [1406] = {
            ...
            [questKeys.objectivesText] = {"Reach the maximum level again."},
            [questKeys.triggerEnd] = {"Reach the maximum level again", {}},
            [questKeys.zoneOrSort] = sortKeys.PRESTIGE,
        },
		[24656] = {
